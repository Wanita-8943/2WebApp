...
import sys
sys.path.append('..//2WebApp/templates/Age.h5')
...
model1 = tf.keras.models.load_model('..//2WebApp/templates/Age.h5')
model1.make_predict_function()


sys.path.append('..//2WebApp/templates/Gender.h5')
...
model2 = tf.keras.models.load_model('..//2WebApp/templates/Gender.h5')
...
def upload():
    if request.method == 'POST':
        ...
        app.config['UPLOAD_FOLDER'] = '/root//2WebApp/static'
        results = []
